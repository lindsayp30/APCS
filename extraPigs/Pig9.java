...
/*
When there is a capitalized word with a punctuation appended, the first letter that is moved to the end is still capitalized 
some test cases that don't work: 
- Hello!
- Boy Toy.
When there are multiple consonants at the beginning of a word which is capitalized, there is wonk.
- Chair
- Rhythm
- Stew 
- Thrice
